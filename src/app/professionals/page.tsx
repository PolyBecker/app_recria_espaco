...
export default function ProfessionalsPage() {
  ...
  const worksRef = useDragScroll<HTMLDivElement>();
  const storeRef = useDragScroll<HTMLDivElement>();
  ...
  return (
    <div className="min-h-screen bg-[#FDFDFB] px-4 py-6 flex flex-col space-y-6 pb-20">
      ...
      <div ref={worksRef} className="overflow-x-auto px-4 pb-2 cursor-grab no-scrollbar">
      ...
      <div className="px-4">
        ...
        <div ref={storeRef} className="flex space-x-4 overflow-x-auto cursor-grab no-scrollbar">
          {storeItems.map((file) => {
